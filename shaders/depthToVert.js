  ...
  void main() {
    ...
    float z = imageLoad(depthImage, u).x * (6.55350f); // this has been manually set and depends on the depth scale set by the realsense sdk, its the short->float scaled by depth scale, seems to work. 65.xxx is the default setting on the sensor 1000 units
